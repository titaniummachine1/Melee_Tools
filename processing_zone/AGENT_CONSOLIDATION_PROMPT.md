...
For each symbol, choose **1-3 best examples**:
- **Priority 1**: Standard/common usage pattern
- **Priority 2**: Edge case or advanced usage
- **Priority 3**: Custom helper implementation (if applicable)
