...
-- Last updated: 2025-12-05T05:05:22.883Z

---@class StudioHitboxSet
---@return any
---@field Methods fun(self: StudioHitboxSet): any
---@return any
---@field Examples fun(self: StudioHitboxSet): any
---@return string
---@field GetName fun(self: StudioHitboxSet): string
---@return any
