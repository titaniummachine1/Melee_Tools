...
-- Last updated: 2025-12-05T03:42:28.895Z

---@class PhysicsSolid
---@return any
---@field Methods fun(self: PhysicsSolid): any
---@return string
---@field GetName fun(self: PhysicsSolid): string
---@return string
---@field GetSurfacePropName fun(self: PhysicsSolid): string
---@return any
