...
-- Last updated: 2025-12-05T09:57:52.836Z

---@class EulerAngles
---@return any
---@field Constructor fun(self: EulerAngles): any
---@return any
---@field Fields fun(self: EulerAngles): any
---@return any
---@field Methods fun(self: EulerAngles): any
---@return any
---@field Examples fun(self: EulerAngles): any
---@return Vector3
