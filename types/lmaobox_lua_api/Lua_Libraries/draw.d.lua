...
-- Last updated: 2025-12-05T10:33:20.570Z
...
-- Draw the texture by textureId as a polygon. The vertices table should be a list of tables, each containing 4 values: x,y of the vertex, and u,v of the tex coordinate. Example vertex = { 0,0,0.1,0.5 }. clipVertices decides whether the resulting polygon should be clipped to the screen or not. If un...
---@param textureId number
