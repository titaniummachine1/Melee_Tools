...
const html = fs.readFileSync('../.cache/docs/TF2_props.html', 'utf8');
const ents = parseEntityPropsFromHtml(html);
fs.writeFileSync('./entities-debug.json', JSON.stringify({ count: ents.length, sample: ents.slice(0, 5) }, null, 2));
